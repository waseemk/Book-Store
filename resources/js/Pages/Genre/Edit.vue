        ...
        <div class="col-lg-12 mt-5">
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    ...
                    <a class="float-end text-white text-decoration-none me-3" :href="route('genres')"><b>&lt; Back</b></a>
                </div>
                <div class="card-body">
                    <div class="col-md-12">
                        <form @submit.prevent="form.patch(route('genres.update', genre.id))" class="col-md-6">
                            <div class="mb-3 row">
